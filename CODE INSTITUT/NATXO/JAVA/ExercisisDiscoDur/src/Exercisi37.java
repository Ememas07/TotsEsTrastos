public class Exercisi37 {
    public static void main(String[] args) {
        ...
        // los setters. Create un arrays de Mes (mirate la funcion values), pide un
        // numero por teclado e indica que meses tienen ese numero de dias (toda su
        // informacion). Por ejemplo, si escribes un 28, este te devolvera la
