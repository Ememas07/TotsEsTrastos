...
CREATE DATABASE IF NOT EXISTS act8;

USE act8; 



CREATE TABLE IF NOT EXISTS act8.DEPT (
...
INSERT INTO act8.DEPT VALUES (10, 'COMPTABILITAT', 'SEVILLA');
INSERT INTO act8.DEPT VALUES (20, 'INVESTIGACIÓ', 'MADRID');
INSERT INTO act8.DEPT VALUES (30, 'VENDES', 'BARCELONA');
INSERT INTO act8.DEPT VALUES (40, 'PRODUCCIÓ', 'BILBAO');


CREATE TABLE IF NOT EXISTS act8.EMP (
 ...
 FOREIGN KEY (DEPT_NO) REFERENCES act8.DEPT(DEPT_NO)) ;


CREATE INDEX EMP_COGNOM ON act8.EMP (COGNOM);
CREATE INDEX EMP_DEPT_NO_EMP ON act8.EMP (DEPT_NO,EMP_NO);

INSERT INTO act8.EMP VALUES (7369,'SÁNCHEZ','EMPLEAT',7902, '1980-12-17', 104000,NULL,20);
INSERT INTO act8.EMP VALUES (7499,'ARROYO','VENEDOR',7698, '1980-02-20', 208000,39000,30);
INSERT INTO act8.EMP VALUES (7521,'SALA','VENEDOR',7698, '1981-02-22', 162500,65000,30);
INSERT INTO act8.EMP VALUES (7566,'JIMÉNEZ','DIRECTOR',7839, '1981-04-02', 386750,NULL,20);
INSERT INTO act8.EMP VALUES (7654,'MARTÍN','VENEDOR',7698, '1981-09-29', 162500,182000,30);
INSERT INTO act8.EMP VALUES (7698,'NEGRO','DIRECTOR',7839, '1981-05-01', 370500,NULL,30);
INSERT INTO act8.EMP VALUES (7782,'CEREZO','DIRECTOR',7839, '1981-06-09', 318500,NULL,10);
INSERT INTO act8.EMP VALUES (7788,'GIL','ANALISTA',7566, '1981-11-09', 390000,NULL,20);
INSERT INTO act8.EMP VALUES (7839,'REY','PRESIDENT',NULL, '1981-11-17', 650000,NULL,10);
INSERT INTO act8.EMP VALUES (7844,'TOVAR','VENEDOR',7698, '1981-09-08', 195000,0,30);
INSERT INTO act8.EMP VALUES (7876,'ALONSO','EMPLEAT',7788, '1981-09-23', 143000,NULL,20);
INSERT INTO act8.EMP VALUES (7900,'JIMENO','EMPLEAT',7698, '1981-12-03', 123500,NULL,30);
INSERT INTO act8.EMP VALUES (7902,'FERNÁNDEZ','ANALISTA',7566, '1981-12-03', 390000,NULL,20);
INSERT INTO act8.EMP VALUES (7934,'MUÑOZ','EMPLEAT',7782, '1982-01-23', 169000,NULL,10);


ALTER TABLE act8.EMP
ADD FOREIGN KEY (CAP) REFERENCES EMP(EMP_NO);



CREATE TABLE IF NOT EXISTS act8.CLIENT (
 ...
 FOREIGN KEY (REPR_COD) REFERENCES act8.EMP(EMP_NO));

CREATE INDEX CLIENT_NOM ON act8.CLIENT (NOM);
CREATE INDEX CLIENT_REPR_CLI ON act8.CLIENT (REPR_COD, CLIENT_COD);


INSERT INTO act8.CLIENT (CLIENT_COD, NOM, ADRECA, CIUTAT, ESTAT, CODI_POSTAL, AREA, 
...
CREATE TABLE IF NOT EXISTS act8.PRODUCTE (
 PROD_NUM     INT (6) UNSIGNED PRIMARY KEY,
 DESCRIPCIO   VARCHAR (30) NOT NULL  UNIQUE);


INSERT INTO act8.PRODUCTE (PROD_NUM, DESCRIPCIO)
...
CREATE TABLE IF NOT EXISTS act8.COMANDA  (
 ...
 FOREIGN KEY (CLIENT_COD) REFERENCES act8.CLIENT(CLIENT_COD) );

CREATE INDEX COMANDA_DATA_NUM ON act8.COMANDA (COM_DATA,COM_NUM);
CREATE INDEX COMANDA_TRAMESA_NUM ON act8.COMANDA (DATA_TRAMESA,COM_NUM);


INSERT INTO act8.COMANDA (COM_NUM, COM_DATA, COM_TIPUS, CLIENT_COD, DATA_TRAMESA, TOTAL)
...
CREATE TABLE IF NOT EXISTS act8.DETALL  (
 ...
 FOREIGN KEY (COM_NUM) REFERENCES act8.COMANDA(COM_NUM),
 FOREIGN KEY (PROD_NUM) REFERENCES act8.PRODUCTE(PROD_NUM));


CREATE INDEX DETALL_PROD_COM_DET ON act8.DETALL (PROD_NUM,COM_NUM,DETALL_NUM);


INSERT INTO act8.DETALL (COM_NUM, DETALL_NUM, PROD_NUM, PREU_VENDA, QUANTITAT, IMPORT)
