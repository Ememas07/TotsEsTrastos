...
public class Llista implements Cua, Pila {
    ...
    public void insertarPrincipiMultiple(int numero, int insercions) {
        for (int i = 0; i < insercions; i++) {
            this.insertarPrincipi(numero); //insertam el nombre tantes vegades com volem
        }
    }

    @Override
    public void encoarMultiple(int numero, int insercions) {
        this.insertarPrincipiMultiple(numero, insercions);
    }
    ...
    public void apilar(int numero) {
        this.insertarPrincipi(numero); //posariem un plat al principi de la pila
    }

    @Override
    public void desapilar() {
        this.eliminarElement(0); //llevam el plat d'adalt de tot
    }
