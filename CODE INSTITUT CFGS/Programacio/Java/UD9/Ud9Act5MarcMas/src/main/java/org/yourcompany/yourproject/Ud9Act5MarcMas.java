...
/**
 * Implementar un programa en el que, emprant una Coa anònima, s'encoen nombres
 * enters fins que s'introdueix un valor negatiu
 *
 * Després desencoar tots els valors mostrant-los per pantalla
 *
 * @author Marc Mas
 */
