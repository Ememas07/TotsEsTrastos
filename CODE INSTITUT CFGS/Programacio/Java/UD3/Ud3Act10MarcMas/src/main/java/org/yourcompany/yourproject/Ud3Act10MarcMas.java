...
public class Ud3Act10MarcMas {
    ...
    public static void main(String[] args) {
        ...
        for (int linea = altura; linea > 0; linea--) { //bucle 1 per definir la quantiat de pixels verticals
            for (int caracter = linea; caracter > 0; caracter--) { // bucle 2 per la horizontal, imprimeix en linea i agafa el valor del bucle anterior.
