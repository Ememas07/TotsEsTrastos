...
/**
 * Sobrecarregar els constructors de la classe CompteBancari, per a poder crear
 * objectes:
 *
 * Amb DNI, nom del titular i un saldo inicial
 *
 * Amb DNI i saldo inicial
 *
 * Escriu un programa que comprovi el funcionament dels constructors.
 *
 * @author Marc Mas
 */
