...
docker-compose -f "${PROJECT_DIR}/docker/docker-compose-arm.yaml" --env-file="${PROJECT_DIR}/.env.local" --project-directory "${PROJECT_DIR}" up -d
# docker-compose -f docker-compose-x86-x86.yaml --env-file="../.env.local"
