    ...
    public static void main(String[] args) {
        ...
        switch (seleccio) {
            case 1:
                ...
                Float ivaPreu = (float) (preu * 0.21); // multiplic per 0.21 per saber només l'IVA
            ...
            case 2:
                ...
                Float iva = (float) (preuTotal - (preuTotal / 1.21)); // multiplic per 0.21 per saber només l'IVA
