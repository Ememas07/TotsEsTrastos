        ...
        switch (versio) {
            case 0 -> {
                ...
                for (int i = 1; i < input; i++) { //desde i fins al nombre i sumant 1 cada pic
                    resultat *= i; //multiplicam resultat * i cada vegada, o sigui, 5x1,5x2,5x3... fins a 5x4 (5x5 ja no)
                }
            ...
            case 1 -> {
                ...
                for (int i = 1; i < input2; i++) { //desde i fins al nombre i sumant 1 cada pic
                    resultat2 *= i; //multiplicam resultat * i cada vegada, o sigui, 5x1,5x2,5x3... fins a 5x4 (5x5 ja no)
                }
                System.out.println(resultat2); //imprimim per pantalla
            }
            default -> System.out.println("No has especificat versio correcta, programa acabat");
        }
